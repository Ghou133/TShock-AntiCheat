...
/// <summary>Observation-only switch. Reward samples never establish item ownership or a sanction.</summary>
public sealed record M18RewardObservationOptions(bool Enabled)
{
    public static M18RewardObservationOptions Disabled { get; } = new(false);
}
...
public sealed class M18ImportantItemRewardObserver
{
    ...
    private readonly M18RewardObservationOptions options;
    ...
    public M18ImportantItemRewardObserver(M18RewardObservationOptions options,
